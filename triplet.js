...
/** @type {Object.<String, TargetMatcher>} */
...
/**
 * @typedef ProjectPartial
 * @prop {String} name
 * @prop {Array<String>} [_names]
 */

/**
 * @typedef KnownMatch
 * @prop {Boolean} _deleteme
 */

/**
 * @typedef BuildAssetPartial
 * @prop {String} name
 * @prop {String} version
...
/**
 * @param {ProjectPartial} proj
 * @param {BuildAssetPartial} build
 */
...
/**
 * @param {Partial<TargetTriplet>} partialTarget - expected to be an empty object
 * @param {ProjectPartial} proj
 * @param {BuildAssetPartial} build
 * @param {Array<String>} terms
 */
Triplet.termsToTarget = function (partialTarget, proj, build, terms) {
  /* jshint maxcomplexity:25 */

  let target = Object.assign(partialTarget, {
    os: build.os || '',
    android: false,
    arch: build.arch || '',
    vendor: build.vendor || '',
  ...
  for (let term of terms) {
    ...
    upsertTarget(proj.name, build, terms, target, knownMatch, checkForMismatch);
  }
 ...
 * @param {TargetMatcher} knownMatches
 ...
 * @param {Boolean} checkForMismatch
 */
function upsertOs(name, build, terms, target, knownMatches, checkForMismatch) {
...
export let TERMS_CHANNEL = Triplet.TERMS_CHANNEL;
export let TERMS_CHECKSUM = Triplet.TERMS_CHECKSUM;
export let TERMS_NON_BUILD = Triplet.TERMS_NON_BUILD;
export let _RE_TERMS_NON_BUILD = Triplet._RE_TERMS_NON_BUILD;
export let TERMS_EXTS_NON_BUILD = Triplet.TERMS_EXTS_NON_BUILD;
export let TERMS_EXTS_PKG = Triplet.TERMS_EXTS_PKG;
export let TERMS_EXTS_ZIP = Triplet.TERMS_EXTS_ZIP;
export let TERMS_EXTS_NON_INFORMATIVE = Triplet.TERMS_EXTS_NON_INFORMATIVE;
export let TERMS_EXTS_SOURCE = Triplet.TERMS_EXTS_SOURCE;
export let TERMS_PRIMARY_MAP = Triplet.TERMS_PRIMARY_MAP;
export let TERMS_TIERED_MAPS = Triplet.TERMS_TIERED_MAPS;
export let maybeInstallable = Triplet.maybeInstallable;
export let toPattern = Triplet.toPattern;
export let patternToTerms = Triplet.patternToTerms;
export let termsToTarget = Triplet.termsToTarget;
export let buildToPackageType = Triplet.buildToPackageType;
export let filenameToPackageType = Triplet.filenameToPackageType;
